...
if (!undefined.states.selection) {
  var table_store_selection = localStorage.getItem('selection');
  if (table_store_selection) {
    undefined.states.selection = JSON.parse(table_store_selection);
  }
}
